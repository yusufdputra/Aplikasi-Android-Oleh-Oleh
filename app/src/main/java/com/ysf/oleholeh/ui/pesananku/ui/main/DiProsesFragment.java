...
public class DiProsesFragment extends Fragment implements View.OnClickListener {
    private String idUser;

    private ImageView iv_empty_list;
    private RecyclerView rv_diproses;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_diproses, container, false);
    ...
    private void init(View root) {
        ...
        rv_diproses = root.findViewById(R.id.rv_diproses);
    ...
    private void getListPesanan() {
        ...
        options_pesanan = new FirestoreRecyclerOptions.Builder<PemesananModel>()
                .setQuery(ref_pemesanan.whereEqualTo("id_user", idUser).whereEqualTo("id_status_pemesanan", "2"), PemesananModel.class)
                .build();

        rv_diproses.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        ...
        adapterPemesanan = new FirestoreRecyclerAdapter<PemesananModel, PemesananViewHolder>(options_pesanan) {
            ...
            public void onDataChanged() {
                if (getItemCount() == 0){
                    ...
                    rv_diproses.setVisibility(View.VISIBLE);
                }
            }
            @Override
            protected void onBindViewHolder(@NonNull PemesananViewHolder holder, int i, @NonNull PemesananModel pemesananModel) {
                ...
                holder.btn_detail.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(KEY_STATUS_PESANAN, STATUS_PROSES);
